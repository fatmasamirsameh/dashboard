  ...
  if(empty($title)){
   ...
   if(empty($desc)){
    ...
    $errorMessages['desc'] = "desc Field Required";
        ...
        //       # code...
        //       $errorMessages['desc']  = "Only chars allowed";
...
if(empty($price)){
   ...
   # Upload Image . . .
     ...
     if(count($errorMessages) == 0){
      ...
      $sql = "insert into products ( `title`, `desc`, `added_by`, `cat_id`, `image`,`price`) values ('$title','$desc', $addedBy ,$cat_id,'$image',$price)";
                        ...
                        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="small mb-1" for="inputEmailAddress">Price</label>
                                 <textarea class="form-control py-4" name="price"></textarea>
